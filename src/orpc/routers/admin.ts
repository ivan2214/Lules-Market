...
export const getAdminDashboardStats = o
  .use(authMiddleware({ role: "admin" }))
  .route({
    method: "GET",
...
export const getAnalyticsData = o
  .use(authMiddleware({ role: "admin" }))
  .route({
    method: "GET",
...
export const deleteBusinessByIds = o
  .use(authMiddleware({ role: "admin" }))
  .route({
    method: "DELETE",
...
export const getTrialsAndActiveCount = o
  .use(authMiddleware({ role: "admin" }))
  .route({
    method: "GET",
