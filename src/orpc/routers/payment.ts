...
export const createPreference = o
  .use(
    authMiddleware({
      role: "business",
    }),
  ...
  .handler(async ({ context, input }) => {
    ...
    if (!currentBusiness) {
      throw new ORPCError("BAD_REQUEST", {
        message: "No tienes un comercio activo",
      });
    }
