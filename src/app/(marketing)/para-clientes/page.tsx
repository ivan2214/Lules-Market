        ...
        <Card className="bg-card/50 backdrop-blur-sm">
          <CardContent className="flex flex-col items-center p-6 text-center">
            ...
            <p className="text-muted-foreground">
              Busca específicamente por categoría, nombre del comercio o tipo de
              producto. Encuentra resultados precisos en segundos.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-card/50 backdrop-blur-sm">
          <CardContent className="flex flex-col items-center p-6 text-center">
            ...
            <p className="text-muted-foreground">
              ...
              servicios. Conecta directamente con negocios reales de tu ciudad.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mx-auto max-w-5xl">
        <div className="grid gap-8 md:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            <h2 className="font-bold text-3xl">¿Por qué usar Lules Market?</h2>
            <ul className="space-y-4">
              ...
              <li className="flex gap-3">
                ...
                <div>
                  ...
                  <span className="text-muted-foreground">
                    Sin registros complicados para buscar. Entras y encuentras.
                  </span>
                </div>
              </li>
            </ul>
