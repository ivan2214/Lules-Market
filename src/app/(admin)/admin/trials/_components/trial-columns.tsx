...
function TrialColumnsInner({ trials }: { trials: TrialWithRelations[] }) {
  const [selectedTrial, setSelectedTrial] = useState<TrialWithRelations | null>(
    null,
  );
  ...
  const columns: ColumnDef<TrialWithRelations>[] = [
    {
