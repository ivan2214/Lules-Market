...
import { businessSignInAction } from "@/app/(auth)/_actions/auth-actions";
import type { BusinessSignInInput } from "@/features/(auth)/_types";
import { BusinessSignInInputSchema } from "@/features/(auth)/_validations";
...
export function SignInForm() {
  ...
  const form = useForm<BusinessSignInInput>({
