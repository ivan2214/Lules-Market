...
export const getStats = businessAuthorized
  ...
  .handler(async ({ context, input }) => {
    return getStatsCached(context.business.id, input);
  });

async function getProductStatsCached(
  businessId: string,
...
export const getProductStats = businessAuthorized
  ...
  .handler(async ({ context, input }) => {
    return getProductStatsCached(context.business.id, input);
  });
