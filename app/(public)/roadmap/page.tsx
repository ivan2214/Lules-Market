      ...
      <div className="container grow py-16">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="mt-6 text-pretty text-lg text-muted-foreground">
            ...
            adopción, esto es lo que planeamos implementar para potenciar aún
            más el comercio local.
          </p>
        </div>
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    ...
                    publicaciones, responder consultas y gestionar la identidad
                    de la marca.
                  </CardDescription>
                </CardContent>
              </Card>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <CardDescription className="mt-2">
                      ...
                      llevar la plataforma a ciudades vecinas, creando una red
                      de comercio local más amplia pero manteniendo la identidad
                      de cada comunidad.
                    </CardDescription>
                  </div>
                </div>
